...
def remove_from_order(parameters: dict, session_id: str):
    if  session_id not in inprogress_orders:
        return JSONResponse(content = 
                            {"fulfilmentText": "I'm having trouble processing your order. Kindly make new order"})
...
def complete_order(parameters: dict, session_id: str):
    if session_id not in inprogress_orders:
        ...
        if order_id == -1:
            ...
            fulfillment_text = f"Awesome I've placed your order.\n Here is your order id: {order_id} \n Your order total is{order_total} which you can pay at the time of delivery"
